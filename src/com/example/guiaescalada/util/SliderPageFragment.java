...
public class SliderPageFragment extends Fragment{
    ...
    private static int numeroLugares;
    private String nombre = new String();
    private String nombreImagen = new String();
    
    public static SliderPageFragment newInstance(int color, int index, Lugar oLugar, int cantidadLugares){
 
        SliderPageFragment fragment = new SliderPageFragment();
        numeroLugares = cantidadLugares;
 
        //Guarda los parametros que tendrá cada item
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        //Cargo los parametros de cada página
