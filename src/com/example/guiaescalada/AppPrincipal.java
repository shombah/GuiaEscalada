    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if(lugaresVisitados != null){
        	...
        	if(lugaresVisitados.size() == 1)
        		lblLugaresVisitados.setText("Último lugar visitado");
        	if(lugaresVisitados.size() == 2)
        		lblLugaresVisitados.setText("Últimos 2 lugares visitados");
        	if(lugaresVisitados.size() == 3)
        		lblLugaresVisitados.setText("Últimos 3 lugares visitados");
        	if(lugaresVisitados.size() == 4)
        		lblLugaresVisitados.setText("Últimos 4 lugares visitados");
