	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		*/
		...
		/*
			...
			The AR.Drawables can be defined for multiple targets.
			A target can be the camera, the radar or a direction indicator.
	...
	locationChanged: function locationChangedFn(lat, lon, alt, acc) {
		...
		*/
		//if (!World.initiallyLoadedData) {
			var poiData = {
				"id": 1,
				"longitude": (lon + -71.602871),
				"latitude": (lat +  -33.050723),
				"altitude": 100.0
			};
